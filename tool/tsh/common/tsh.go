...
func Run(ctx context.Context, args []string, opts ...CliOption) error {
	...
	dbExec.Flag("--stop-on-error", "Stops immediately when encountered an error. By default, execution is attempted on all database services.").BoolVar(&cf.StopOnError)
